...
#include "depalletizing_mapping_method/KMeans.hpp"
...
namespace depalletizing_mapping
{
    ...
    std::vector<Point3> KMeans::GetOutputData() const
    {
        return mOutputData;
    }
    void KMeans::SetOutputData(const std::vector<Point3>& outputData)
    {
        mOutputData = outputData;
    }

	camel::Point2 KMeans::GetOneCentroid() const
	{
		return mCentroids[0];
	}
